  ...
  return (
    <header className='py-4 px-12 flex items-center justify-between bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50'>
      ...
      <div className='hidden lg:flex items-center gap-3'>
        <Link
          to='#'
          className='bg-black opacity-1 hover:opacity-50 w-[26px] h-[26px] rounded-full flex items-center justify-center'
        >
      ...
      <nav className='hidden lg:flex items-center gap-6'>
        ...
        <Link to='/about' className='relative group text-sm'>
          About us
          <span className='absolute bottom-0 left-0 w-0 h-[2px] bg-current transition-all duration-300 group-hover:w-full'></span>
        </Link>
      </nav>
